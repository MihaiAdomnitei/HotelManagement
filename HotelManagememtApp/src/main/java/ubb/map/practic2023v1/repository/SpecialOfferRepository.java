...
public class SpecialOfferRepository implements IRepository<Double, SpecialOffer> {
    ...
    public Optional<SpecialOffer> save(SpecialOffer entity) {
        ...
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
            ...
            stmt.setDate(3, new Date(entity.getStartDate().getTime()));
            stmt.setDate(4, new Date(entity.getEndDate().getTime()));
    ...
    public Optional<SpecialOffer> update(SpecialOffer entity) {
        ...
        try (PreparedStatement stmt = connection.prepareStatement(sql)) {
            ...
            stmt.setDate(2, new Date(entity.getStartDate().getTime()));
            stmt.setDate(3, new Date(entity.getEndDate().getTime()));
